...
var smallUncompressedSizes = []int{32, 64, 128, 256}
var mediumUncompressedSizes = []int{2048, 4096, 8192}
var largeUncompressedSizes = []int{32, 64, 128, 256}
